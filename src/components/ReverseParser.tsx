...
import { celebrateWithConfetti, FIELD_SPECS, formatRef } from "../utils";
        ...
        {verseData && (
          <div className="space-y-4">
            ...
            <div className="text-xs text-slate-500">
              <p>
                <strong>How to use:</strong> Type the Greek word in each box. When correct, the box
                will turn green. Use the morphological details below each box to help you construct
                the correct form from the lemma.
              </p>
            </div>
          </div>
        )}
